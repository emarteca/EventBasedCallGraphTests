...
var stringToArrayBuffer = require('string-to-arraybuffer');
var URLSearchParams_Polyfill = require('@ungap/url-search-params');
var URL = require('whatwg-url').URL;
var AbortController = require('abortcontroller-polyfill/dist/abortcontroller').AbortController;
var AbortController2 = require('abort-controller');
...
// test subjects
var FetchError = require('fetch').FetchError;
var Headers = require('fetch').Headers;
var Request = require('fetch').Request;
var Response = require('fetch').Response
const fetch = require('fetch');
var FetchErrorOrig = require('../src/fetch-error.js');
var HeadersOrig = require('../src/headers.js') 
var createHeadersLenient = require('../src/headers.js').createHeadersLenient;
var RequestOrig = require('../src/request.js');
var ResponseOrig = require('../src/response.js');
var Body = require('../src/body.js');
var getTotalBytes = require('../src/body.js').getTotalBytes
var extractContentType = require('../src/body.js').extractContentType;
